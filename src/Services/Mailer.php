    ...
    public static function sendOrderMail($email):bool {
        ...
        if (isset($email) && !empty($email)) {
            try {
                ...
                $mail->Subject = 'Заявка с сайта: Trenazherniy zal';
                $mail->Body = "Информационное сообщение c сайта Trenazherniy zal <br><br>
                ------------------------------------------<br><br>
                Спасибо!<br><br>
                Ваш абонемент успешно создан и передан администратору.<br><br>
...
$verification_link = Config::SITE_URL . "/verify/" . $verification_token;
                ...
                $mail->Subject = "Подтверждение регистрации с сайта: Trenazherniy zal";
                $mail->Body = "Информационное сообщение c сайта Trenazherniy zal <br><br>
                ------------------------------------------<br><br>
