            ...
            <main class="row p-5">
               <div class="card mb-3" style="max-width: 540px;">
                    <div class="row g-0">
                        ...
                        <img src="{$data['image']}" class="img-fluid rounded-start" alt="Изображение абонемента">
                        </div>
                        <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <form class="mt-4" action="/trenazherka/basket" method="POST">
      ...
      foreach ($arr as $key => $item) {
          $element_template = <<<HTML
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <h5 class="card-title"><a href="https://localhost/trenazherka/products/{$item['id']}">{$item['name']}</a></h5>
