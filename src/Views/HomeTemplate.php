...
<div class="h-50 w-50 mx-auto">        
    <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner" style="height:50vh;">
            ...
            <img src="https://localhost/pizza221/assets/images/image1.png" class="d-block w-100 h-80" alt="...">
            </div>
            <div class="carousel-item">
            <img src="https://localhost/pizza221/assets/images/image2.png" class="d-block w-100 h-100 " alt="...">
            </div>
            <div class="carousel-item">
            <img src="https://localhost/pizza221/assets/images/image3.png" class="d-block w-100 h-100" alt="...">
            </div>
        </div>
