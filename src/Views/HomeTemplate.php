...
class HomeTemplate extends BaseTemplate
{
    public static function getTemplate(): string {
            ...
            <div class="h-50 w-50 mx-auto">        
                <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner" style="height:65vh;">
                        ...
                        <img src="./assets/images/t1.png" class="d-block w-100 h-100" alt="...">
                        </div>
                        <div class="carousel-item">
                        <img src="./assets/images/t2.png" class="d-block w-100 h-100 " alt="...">
                        </div>
                        <div class="carousel-item">
                        <img src="./assets/images/t3.png" class="d-block w-100 h-100" alt="...">
                        </div>
                    </div>
        ...
        <main class="row">
            <div class="p-5">
                <p>Здесь можно заказать ,бытовую технику с доставкой по городу Кемерово.</p>
