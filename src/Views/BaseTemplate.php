            ...
            <ul class=" navbar-nav ">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="/trenazherka/profile">Профиль</a></li>
                        <li>
                            <hr class="dropdown-divider">
                        </li>
                        <li><a class="dropdown-item" href="/trenazherka/logout">Выход</a></li>
                    </ul>
                </li>
            </ul>
...
$template .= <<<HTML
    ...
    <a class=" f nav-link p-3" href="/trenazherka/login">
    Вход
    </a>
